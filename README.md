...
本项目希望把课堂上学到的“栈、队列、图遍历、优先队列、启发式搜索”等知识点放进一个完整的小型工程中，而不是只停留在纸面推导或命令行输出结果。相比单纯打印路径，MazeSolver 更强调“可玩性 + 可视化展示”的结合，使迷宫生成、手动闯关和自动求解过程都更容易观察和理解。
...
`https://github.com/yinzhen0513/MazeSolver`
